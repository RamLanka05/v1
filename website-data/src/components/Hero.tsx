export default function Hero() {
  return (
    ...
    <div className="w-full max-w-[560px] mx-auto lg:mx-0 lg:ml-4 lg:w-full lg:pr-12">
        ...
        <p className="text-lg text-gray-300 mb-8 max-w-md leading-relaxed text-left lg:pr-6">
